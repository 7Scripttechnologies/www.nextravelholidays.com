    ...
    >
      ...
      {pending.length > 0 ? (
              ...
              >
                <div className="relative aspect-[16/10] bg-[#0A0A0A]">
                  <Image
                    ...
                    unoptimized={/^https?:\/\//i.test(item.publicPath)}
                  />
                </div>
        ...
        <div className="mt-7 rounded-[24px] border border-white/[0.08] bg-[#141414] p-8 text-center sm:mt-8 sm:p-12">
          ...
          <p className="mt-4 text-lg font-bold text-[#EDEDED]">All images optimised</p>
          <p className="mx-auto mt-2 max-w-md text-sm text-muted">
            The waiting list is empty. New or replaced photos will show up here until you run
            optimise again.
          </p>
