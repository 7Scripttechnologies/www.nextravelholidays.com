    ...
    <>
      ...
      <main>
        <PageHero
          ...
          cta={{ href: inquiryUrl, label: "WhatsApp Inquiry" }}
            ...
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12">
              <div>
                ...
                <div className="mt-6 flex flex-wrap gap-3 text-sm">
                  <a
                    href={contact.instagram || siteConfig.socials.instagram}
                    target="_blank"
                  ...
                  <a
                    href={contact.googleBusiness || siteConfig.socials.googleBusiness}
                    target="_blank"
                    rel="me noopener noreferrer"
                    className="font-semibold text-brand transition hover:text-[#EDEDED]"
                  >
