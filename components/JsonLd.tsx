...
export default function JsonLd({ contact }: { contact: SiteContact }) {
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: `Contact NexTravel Holidays on WhatsApp or call ${contact.phoneDisplay}, email ${siteConfig.email}, or use the contact form on nextravelholidays.com. Browse destinations and package details on the website.`,
          },
        },
      ],
    },
