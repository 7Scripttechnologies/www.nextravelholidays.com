...
export default async function Footer() {
  ...
  const socials = [
    { ...socialMeta[0], href: contact.facebook },
    { ...socialMeta[1], href: contact.instagram },
    { ...socialMeta[2], href: contact.x },
    { ...socialMeta[3], href: contact.youtube },
    { ...socialMeta[4], href: contact.googleBusiness },
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-10 md:grid-cols-4 md:gap-x-10 lg:gap-x-12">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-muted">
                ...
                <li>
                  <a href={`tel:${contact.phoneTel}`} className="transition hover:text-brand">
                    {contact.phoneDisplay}
                  </a>
                </li>
                <li className="leading-6">Service area: {contact.serviceArea}</li>
              </ul>
            </div>
          </div>
