...
const navItems = [
  { href: "/admin", label: "Dashboard", icon: LayoutDashboard, id: "packages" as const },
];
  ...
  return (
    <div className="min-h-svh bg-black">
      ...
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-[260px] flex-col border-r border-white/[0.07] bg-[#0B0B0B] lg:flex">
        {/* Brand row — same height as topbar so they form one header */}
        <div
          className={cn(
        ...
        >
          ...
          <span className="rounded-full bg-[#E20E17] px-2.5 py-1 text-[10px] font-bold tracking-[0.12em] text-white uppercase">
            Admin
          </span>
        </div>
      ...
      <header className="fixed inset-x-0 top-0 z-40 border-b border-white/[0.07] bg-black/95 backdrop-blur-md lg:hidden">
        <div className="flex h-14 items-center justify-between gap-2 px-3 sm:h-16 sm:gap-3 sm:px-4">
          <div className="flex min-w-0 flex-1 items-center gap-2">
            <Logo
              imageClassName="h-7 max-w-[132px] sm:h-8 sm:max-w-[160px]"
              className="min-w-0"
            />
            <span className="shrink-0 rounded-full bg-[#E20E17] px-2 py-0.5 text-[9px] font-bold tracking-[0.12em] text-white uppercase sm:px-2.5 sm:text-[10px]">
              Admin
            </span>
          </div>
      ...
      <div className="min-w-0 lg:pl-[260px]">
        {/* Fixed desktop topbar — aligns with sidebar brand row */}
        <header
          className={cn(
        ...
        <main className="px-3 pt-16 pb-8 sm:px-6 sm:pt-[72px] lg:px-8 lg:pt-[112px] lg:pb-10 xl:px-10">
          ...
          <div className="mb-6 flex flex-col gap-3 sm:mb-8 lg:hidden">
            <div className="min-w-0">
              ...
              <h1 className="mt-1 text-[24px] leading-tight font-extrabold tracking-tight text-[#EDEDED] sm:text-[28px]">
                {title}
              </h1>
              {description ? (
